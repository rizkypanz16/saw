<?php
 ...
 function getNama($id){
  $q =mysql_query("SELECT * FROM tb_siswa where id_siswa = '$id'");
  $d = mysql_fetch_array($q);
  return $d['nama_siswa'];
 }
 
 echo'<a href="http://localhost/saw/beranda.php">beranda</a>';
...
//Kita gunakan rumus (Normalisasi x bobot)
 while ($dt3 = mysql_fetch_array($sql3)) {
  ...
  $data[]=array('nama'=>getNama($dt3['siswa']),
      'jumlah'=>$jumlah,
      'poin'=>$poin);
